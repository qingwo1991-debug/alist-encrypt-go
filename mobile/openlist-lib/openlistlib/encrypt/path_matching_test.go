...
func TestPathMatchingWithoutLeadingSlash(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			// 有前导 / 的联通云盘
			configPath: "/unicom_cloud/encrypt/*",
			testPaths: []string{
				"/unicom_cloud/encrypt/test.mp4",
			},
			shouldMatch: true,
		},
	}
...
func TestActualPathConfig(t *testing.T) {
	...
	configPaths := []string{
		"/local_storage/",
		"user_storage/encrypt/",  // 没有前导 /
		"/backup_storage/encrypt/",
		"/telecom_cloud/cloud_storage/encrypt/",
		"/unicom_cloud/encrypt/",
		"/doubao_cloud/encrypt/",
		"/google_drive_2/",
		"/google_drive_1/",
	}
