...
class OpenListService : Service(), OpenList.Listener {
    companion object {
        ...
        const val ACTION_SHUTDOWN =
            "com.openlist.mobile.service.OpenListService.ACTION_SHUTDOWN"

        const val ACTION_COPY_ADDRESS =
            "com.openlist.mobile.service.OpenListService.ACTION_COPY_ADDRESS"

        const val ACTION_STATUS_CHANGED =
            "com.openlist.mobile.service.OpenListService.ACTION_STATUS_CHANGED"
