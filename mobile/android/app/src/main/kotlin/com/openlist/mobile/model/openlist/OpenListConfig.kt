...
data class OpenListConfig(
    ...
    val bleveDir: String = "", // /storage/emulated/0/Android/data/com.openlist.encrypt.debug/files/data/bleve
    @SerialName("cdn")
    val cdn: String = "",
//    @SerialName("database")
...
//    val log: Log = Log(),
    ...
    val siteUrl: String = "",
    @SerialName("temp_dir")
    val tempDir: String = "", // /storage/emulated/0/Android/data/com.openlist.encrypt.debug/files/data/temp
    ...
    data class Database(
        @SerialName("db_file")
        val dbFile: String = "", // /storage/emulated/0/Android/data/com.openlist.encrypt.debug/files/data/data.db
        @SerialName("host")
        val host: String = "",
        @SerialName("name")
        val name: String = "",
    ...
    data class Log(
        ...
        @SerialName("name")
        val name: String = "" // /storage/emulated/0/Android/data/com.openlist.encrypt.debug/files/data/log/log.log
    )
