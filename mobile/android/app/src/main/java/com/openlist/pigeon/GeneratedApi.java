...
public class GeneratedApi {
  ...
  public interface NativeCommon {
    ...
    void writeAppLog(@NonNull Long level, @NonNull String msg);
    ...
    static void setUp(@NonNull BinaryMessenger binaryMessenger, @Nullable NativeCommon api) {
      ...
      }
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(
                binaryMessenger, "dev.flutter.pigeon.openlist_mobile.NativeCommon.writeAppLog", getCodec());
        if (api != null) {
          channel.setMessageHandler(
              (message, reply) -> {
                ArrayList<Object> wrapped = new ArrayList<Object>();
                ArrayList<Object> args = (ArrayList<Object>) message;
                Number levelArg = (Number) args.get(0);
                String msgArg = (String) args.get(1);
                try {
                  api.writeAppLog((levelArg == null) ? null : levelArg.longValue(), msgArg);
                  wrapped.add(0, null);
                }
 catch (Throwable exception) {
                  ArrayList<Object> wrappedError = wrapError(exception);
